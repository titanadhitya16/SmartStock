...
public class Frmsupplier extends javax.swing.JDialog {
    ...
    private void GetData(){
        try {
            ...
            java.sql.ResultSet sql = stm.executeQuery("SELECT tmsupplier.id_supplier, tmsupplier.kode, tmsupplier.nama, tmsupplier.no_telp, tmsupplier.alamat FROM tmsupplier");
    ...
    private void initComponents() {
        ...
        setTitle("SmartStock :: Data Supplier");
    ...
    private void btneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditActionPerformed
        ...
        if(!"0".equals(row_id)){
            try {
                ...
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                java.sql.ResultSet sql = stm.executeQuery("SELECT tmsupplier.id_supplier, tmsupplier.kode, tmsupplier.nama, tmsupplier.no_telp, tmsupplier.alamat FROM tmsupplier WHERE tmsupplier.id_supplier='"+row_id+"'");
                if(sql.next()){
                    lbl_action.setForeground(new Color(43, 152, 240));
                    String kode = sql.getString("kode");
                    lbl_action.setText("Edit Data | " + kode);
                    txtid.setText(sql.getString("id_supplier"));
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        if(!"".equals(row_txtkode) && !"".equals(row_txtnama) && !"".equals(row_txttelp) && !"".equals(row_txtalamat)){
             try {
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                java.sql.ResultSet sql = stm.executeQuery("SELECT COUNT(tmsupplier.id_supplier) as count FROM tmsupplier WHERE tmsupplier.kode='"+row_txtkode+"'");
                sql.next();
            ...
            if("".equals(row_id)){
                ...
                if(c_kode == 0 || row_txtkode.equals(row_txttemp_kode))
                {
                    try {
                        Connection conn = konek.openkoneksi();
                        java.sql.Statement stm = conn.createStatement();
                        stm.executeUpdate("UPDATE tmsupplier SET kode='" + row_txtkode + "',nama='" + row_txtnama + "',no_telp='" + row_txttelp + "',alamat='" + row_txtalamat + "' WHERE id_supplier = '" + row_id + "'");
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        if(ok==0) {
            try {
                ...
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                stm.executeUpdate("DELETE FROM tmsupplier WHERE id_supplier = '" + row_id + "'");
