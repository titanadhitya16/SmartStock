...
public class Frmbarang extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setTitle("SmartStock :: Data Barang");
    ...
    private void btneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditActionPerformed
        ...
        if(!"0".equals(row_id)){
            try {
                ...
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                java.sql.ResultSet sql = stm.executeQuery("SELECT tmbarang.id_barang, tmbarang.kode, tmbarang.nama, tmbarang.id_kategori, tmkategori.nama as kategori, tmbarang.satuan, tmbarang.stok FROM tmbarang JOIN tmkategori ON tmkategori.id_kategori = tmbarang.id_kategori WHERE tmbarang.id_barang='"+row_id+"'");
                if(sql.next()){
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        if(!"".equals(row_txtkode) && !"".equals(row_txtnama) && !"".equals(row_txtkategori) && !"".equals(row_txtsatuan) && !"".equals(row_txtstok)){
            try {
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                java.sql.ResultSet sql = stm.executeQuery("SELECT COUNT(tmbarang.id_barang) as count FROM tmbarang WHERE tmbarang.kode='"+row_txtkode+"'");
                sql.next();
            ...
            if("".equals(row_id)){
                ...
                if(c_kode == 0 || row_txtkode.equals(row_txttemp_kode))
                {
                    try {
                        Connection conn = konek.openkoneksi();
                        java.sql.Statement stm = conn.createStatement();
                        stm.executeUpdate("UPDATE tmbarang SET kode='" + row_txtkode + "',nama='" + row_txtnama + "',id_kategori='" + row_txtkategori + "',satuan='" + row_txtsatuan + "',stok='" + row_txtstok + "' WHERE id_barang = '" + row_id + "'");
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        if(ok==0) {
            try {
                ...
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                stm.executeUpdate("DELETE FROM tmbarang WHERE id_barang = '" + row_id + "'");
    ...
    private void cmbid_kategoriItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbid_kategoriItemStateChanged
        ...
        if(!nm_kategori.equals("")){
            try {
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                java.sql.ResultSet sql = stm.executeQuery("SELECT id_kategori FROM tmkategori WHERE nama='"+nm_kategori+"'");
                if(sql.next()){
                    txtid_kategori.setText(sql.getString("id_kategori"));
                }
                konek.closekoneksi();
