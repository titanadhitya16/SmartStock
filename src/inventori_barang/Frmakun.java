        ...
        if (txtpassword_lama.getPassword().length == 0 || txtpassword.getPassword().length == 0 || txtcpassword.getPassword().length == 0) {
            ...
            if (!(row_txtpassword.equals(row_txtcpassword))) {
                ...
                try {
                    ...
                    java.sql.ResultSet rsLogin = stm.executeQuery("SELECT * FROM tmpetugas WHERE id_petugas = '" + u_id + "'");
                    ...
                    if (rsLogin.next()) {
                        if (BCrypt.checkpw(row_txtpassword_lama, rsLogin.getString("password"))) {
                            try {
                                ...
                                stm2.executeUpdate("UPDATE tmpetugas SET password='" + hashed_password + "' WHERE id_petugas = '" + u_id + "'");
