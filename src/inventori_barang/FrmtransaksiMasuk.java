    ...
    private void cmbid_pelangganItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbid_pelangganItemStateChanged
        ...
        if(!kode.equals("Pilih")){
                ...
                try {
                    Connection conn = konek.openkoneksi();
                    java.sql.Statement stm = conn.createStatement();
                    java.sql.ResultSet sql = stm.executeQuery("SELECT id_supplier FROM tmsupplier WHERE kode='"+kode+"'");
                    if(sql.next()){
                        txtid_pelanggan.setText(sql.getString("id_supplier"));
                    }
                    konek.closekoneksi();
                } catch (SQLException e) {
                    JOptionPane.showMessageDialog(null, "Error " + e);
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        if(rowCount > 0 && !"".equals(row_tgl) && !"".equals(row_idpelanggan) && !"".equals(row_idpetugas)){
            ...
            try {
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                java.sql.ResultSet sql = stm.executeQuery("SELECT MAX(id_barang_masuk) as max FROM trbarang_masuk");
                sql.next();
            ...
            for (int i = 0; i < rowCount; i++) {
                ...
                if(empty == 0){
                    try {
                        Connection conn = konek.openkoneksi();
                        java.sql.Statement stm = conn.createStatement();
                        stm.executeUpdate("DELETE FROM trbarang_masuk WHERE id_barang_masuk = '" + id_barang_masuk + "'");
                        konek.closekoneksi();
                    } catch (SQLException e) {
                        JOptionPane.showMessageDialog(null, "Error " + e);
                    } catch (ClassNotFoundException ex) {
            ...
            try {
                ...
                hash.put("id_barang_masuk", id_barang_masuk);
