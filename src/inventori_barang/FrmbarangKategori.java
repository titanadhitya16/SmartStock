...
public class FrmbarangKategori extends javax.swing.JDialog {
    ...
    private void GetData(){
        try {
            ...
            java.sql.ResultSet sql = stm.executeQuery("SELECT tmkategori.id_kategori, tmkategori.nama, tmkategori.no_rak FROM tmkategori");
    ...
    private void initComponents() {
        ...
        setTitle("SmartStock :: Data Kategori Barang");
    ...
    private void btneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditActionPerformed
        ...
        String row_id_kategori = txtid.getText();
        if(!"0".equals(row_id_kategori)){
            try {
                btnsave.setText("Simpan Perubahan");
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                java.sql.ResultSet sql = stm.executeQuery("SELECT tmkategori.id_kategori, tmkategori.nama, tmkategori.no_rak FROM tmkategori WHERE tmkategori.id_kategori='"+row_id_kategori+"'");
                if(sql.next()){
                    lbl_action.setForeground(new Color(43, 152, 240));
                    String kode = sql.getString("nama");
                    lbl_action.setText("Edit Data | " + kode);
                    txtid.setText(sql.getString("id_kategori"));
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        if(!"".equals(row_txtnama) && !"".equals(row_txtrak)){
             try {
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                java.sql.ResultSet sql = stm.executeQuery("SELECT COUNT(tmkategori.id_kategori) as count FROM tmkategori WHERE tmkategori.nama='"+row_txtnama+"'");
                sql.next();
            ...
            if("".equals(row_id)){
                ...
                if(c_kode == 0 || row_txtnama.equals(row_txttemp_kode))
                {
                    try {
                        Connection conn = konek.openkoneksi();
                        java.sql.Statement stm = conn.createStatement();
                        stm.executeUpdate("UPDATE tmkategori SET nama='" + row_txtnama + "',no_rak='" + row_txtrak + "' WHERE id_kategori = '" + row_id + "'");
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        if(ok==0) {
            try {
                ...
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                stm.executeUpdate("DELETE FROM tmkategori WHERE id_kategori = '" + row_id + "'");
