...
public class Frmpetugas extends javax.swing.JDialog {
    ...
    private void GetData(){
        try {
            ...
            java.sql.ResultSet sql = stm.executeQuery("SELECT tmpetugas.id_petugas, tmpetugas.nama, tmpetugas.username, tmpetugas.status FROM tmpetugas");
    ...
    private void initComponents() {
        ...
        btnrefresh.setFont(new java.awt.Font("Lucida Grande", 0, 11)); // NOI18N
        btnrefresh.setIcon(new javax.swing.ImageIcon(getClass().getResource("/inventori_barang/img/reload.png"))); // NOI18N
    ...
    private void btneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditActionPerformed
        ...
        if(!"0".equals(row_id)){
            try {
                ...
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                java.sql.ResultSet sql = stm.executeQuery("SELECT tmpetugas.id_petugas, tmpetugas.nama, tmpetugas.username, tmpetugas.status FROM tmpetugas WHERE tmpetugas.id='"+row_id+"'");
                if(sql.next()){
            ...
            if(!"".equals(row_txtnama) && !"".equals(row_txtusername) && !"".equals(row_txtpassword)){
                if (txtpassword.getPassword().length == 0 || txtcpassword.getPassword().length == 0) {
                    ...
                    try {
                        Connection conn = konek.openkoneksi();
                        java.sql.Statement stm = conn.createStatement();
                        java.sql.ResultSet sql = stm.executeQuery("SELECT COUNT(tmpetugas.id_petugas) as count FROM tmpetugas WHERE tmpetugas.username='"+row_txtusername+"'");
                        sql.next();
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        if(ok==0) {
            try {
                ...
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                stm.executeUpdate("DELETE FROM tmpetugas WHERE id_petugas = '" + row_id + "'");
